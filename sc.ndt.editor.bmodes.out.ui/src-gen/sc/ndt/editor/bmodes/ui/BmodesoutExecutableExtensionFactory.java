...
import sc.ndt.editor.bmodes.ui.internal.BmodesoutActivator;
...
public class BmodesoutExecutableExtensionFactory extends AbstractGuiceAwareExecutableExtensionFactory {
	...
	protected Injector getInjector() {
		return BmodesoutActivator.getInstance().getInjector(BmodesoutActivator.SC_NDT_EDITOR_BMODES_BMODESOUT);
	}
