...
import sc.ndt.editor.bmodesbmi.BmodesbmiFactory;
...
public class BmodesbmiPackageImpl extends EPackageImpl implements BmodesbmiPackage
{
   ...
   * @see sc.ndt.editor.bmodesbmi.BmodesbmiPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EReference getModelBmodesbmi_Type()
  {
   ...
   * @generated
   */
  public EReference getModelBmodesbmi_InfModel()
  {
   ...
   * @generated
   */
  public EReference getModelBmodesbmi_IndModel()
  {
   ...
   * @generated
   */
  public EReference getModelBmodesbmi_Atoler()
  {
   ...
   * @generated
   */
  public EReference getModelBmodesbmi_TLModel()
  {
   ...
   * @generated
   */
  public EReference getModelBmodesbmi_HLModel()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelBmodesbmiEClass, MODEL_BMODESBMI__TYPE);
    createEReference(modelBmodesbmiEClass, MODEL_BMODESBMI__INF_MODEL);
    createEReference(modelBmodesbmiEClass, MODEL_BMODESBMI__IND_MODEL);
    createEReference(modelBmodesbmiEClass, MODEL_BMODESBMI__ATOLER);
    createEReference(modelBmodesbmiEClass, MODEL_BMODESBMI__TL_MODEL);
    createEReference(modelBmodesbmiEClass, MODEL_BMODESBMI__HL_MODEL);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getModelBmodesbmi_Type(), this.getiBeamType(), null, "type", null, 0, 1, ModelBmodesbmi.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModelBmodesbmi_InfModel(), this.getnRotRpm(), null, "InfModel", null, 0, 1, ModelBmodesbmi.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModelBmodesbmi_IndModel(), this.getnRpmMult(), null, "IndModel", null, 0, 1, ModelBmodesbmi.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModelBmodesbmi_Atoler(), this.getnRadius(), null, "Atoler", null, 0, 1, ModelBmodesbmi.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModelBmodesbmi_TLModel(), this.getnHubRad(), null, "TLModel", null, 0, 1, ModelBmodesbmi.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModelBmodesbmi_HLModel(), this.getnPrecone(), null, "HLModel", null, 0, 1, ModelBmodesbmi.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
