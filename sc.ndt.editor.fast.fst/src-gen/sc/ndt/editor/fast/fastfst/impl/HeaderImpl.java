 ...
 * <ul>
 *   <li>{@link sc.ndt.editor.fast.fastfst.impl.HeaderImpl#getRows <em>Rows</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HeaderImpl extends MinimalEObjectImpl.Container implements Header
{
  ...
  {
    return FastfstPackage.eINSTANCE.getHeader();
  }
  ...
  public EList<String> getRows()
  {
    if (rows == null)
    {
      rows = new EDataTypeEList<String>(String.class, this, FastfstPackage.HEADER__ROWS);
    }
    return rows;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FastfstPackage.HEADER__ROWS:
        return getRows();
    }
