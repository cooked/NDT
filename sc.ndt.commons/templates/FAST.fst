...
---------------------- TURBINE CONFIGURATION -----------------------------------
     0      TipRad       - The distance from the rotor apex to the blade tip (meters)
     ...
     1      OverHang     - Distance from yaw axis to rotor apex [3 blades] or teeter pin [2 blades] (meters)
     ...
     0      NacCMzn      - Vertical distance from the tower-top to the nacelle CM (meters)
     0      TowerHt      - Height of tower above ground level [onshore] or MSL [offshore] (meters)
     0      Twr2Shft     - Vertical distance from the tower-top to the rotor shaft (meters)
...
---------------------- MASS AND INERTIA ----------------------------------------
  ...
  1000     	NacMass      - Nacelle mass (kg)
  1000      HubMass      - Hub mass (kg)
     0      TipMass(1)   - Tip-brake mass, blade 1 (kg)
     0      TipMass(2)   - Tip-brake mass, blade 2 (kg)
     0      TipMass(3)   - Tip-brake mass, blade 3 (kg) [unused for 2 blades]
  1000      NacYIner     - Nacelle inertia about yaw axis (kg m^2)
    10      GenIner      - Generator inertia about HSS (kg m^2)
  1000      HubIner      - Hub inertia about rotor axis [3 blades] or teeter axis [2 blades] (kg m^2)
---------------------- DRIVETRAIN ----------------------------------------------
...
False       GBRevers     - Gearbox reversal {T: if rotor and generator rotate in opposite directions} (flag)
  1000      HSSBrTqF     - Fully deployed HSS-brake torque (N-m)
     1      HSSBrDT      - Time for HSS-brake to reach full deployment once initiated (sec) [used only when HSSBrMode=1]
""    		DynBrkFi     - File containing a mech-gen-torque vs HSS-speed curve for a dynamic brake [CURRENTLY IGNORED] (quoted string)
 100E6      DTTorSpr     - Drivetrain torsional spring (N-m/rad)
   1E6      DTTorDmp     - Drivetrain torsional damper (N-m/(rad/s))
...
"input/tower/tower.twr" TwrFile - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"input/blade/blade.bld"         BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"input/blade/blade.bld"         BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"input/blade/blade.bld"         BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"input/aero/aerodyn.adn"       ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
