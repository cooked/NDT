package sc.ndt.commons.model.airfoillist.providers;
...
import sc.ndt.commons.model.BladeNode;
	...
	public class AirfoilCellEditorProvider  extends EditingSupport {
	    ...
	    protected Object getValue(Object element) {
	    	...
	    	//ISelection prop = aaa.
	        if (element instanceof BladeNode) {
	    ...
	    protected void setValue(Object element,Object value) {
	        if (element instanceof BladeNode /*&& value instanceof Value*/) {
	            BladeNode data = (BladeNode) element;
