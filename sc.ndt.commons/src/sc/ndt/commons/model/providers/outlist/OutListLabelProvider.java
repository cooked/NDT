...
//LabelProvider class
public class OutListLabelProvider extends ColumnLabelProvider implements IStyledLabelProvider {
	...
	public void update(ViewerCell cell) {
		...
		if(e instanceof OutBlock) {

			OutBlock blk = (OutBlock)cell.getElement();

			styledString.append(blk.name);
			styledString.append(" - "+ blk.getAvailableOutChs().size(), StyledString.DECORATIONS_STYLER );
