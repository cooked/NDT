...
import sc.ndt.editor.fast.ui.addon.mpe.AdnMultiPageEditor;

public class AdnMultiPageContentOutline extends Page implements IContentOutlinePage, ISelectionProvider, ISelectionChangedListener {
	...
	private AdnMultiPageEditor editor;

	public AdnMultiPageContentOutline(AdnMultiPageEditor editor) {
		this.editor = editor;
