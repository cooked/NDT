...
public class AdnMultiPageEditor extends FormEditor implements IXtextFormEditor {
	...
	public AdnMultiPageContentOutline getContentOutline() {
		if (fContentOutline == null || fContentOutline.isDisposed()) {
			fContentOutline = new AdnMultiPageContentOutline(this);
	...
	private void updateContentOutline(IFormPage page) {
		...
		if (page instanceof AdnFormPage)
			outline = ((AdnFormPage)page).getContentOutline();
