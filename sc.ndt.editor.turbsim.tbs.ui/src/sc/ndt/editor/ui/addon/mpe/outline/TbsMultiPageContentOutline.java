package sc.ndt.editor.ui.addon.mpe.outline;
...
import sc.ndt.editor.ui.addon.mpe.TbsMultiPageEditor;

public class TbsMultiPageContentOutline extends Page implements IContentOutlinePage, ISelectionProvider, ISelectionChangedListener {
	...
	private TbsMultiPageEditor editor;

	public TbsMultiPageContentOutline(TbsMultiPageEditor editor) {
		this.editor = editor;
