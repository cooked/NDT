...
//import sc.pwdt.cpl.core.ICplProject;
import sc.pwdt.cpl.ui.wizards.buildpaths.BuildPathsBlock;
 ...
 * @since 2.0
 */
public class CplCapabilityConfigurationPage extends NewElementWizardPage {

	private static final String PAGE_NAME= "CplCapabilityConfigurationPage"; //$NON-NLS-1$
	 ...
	 * </p>
	 */
	public CplCapabilityConfigurationPage() {
        super(PAGE_NAME);
        fJavaProject= null;
