...
public class FstMultiPageContentOutline extends Page implements IContentOutlinePage, ISelectionProvider, ISelectionChangedListener {
	...
	public FstMultiPageContentOutline(FstMultiPageEditor editor) {
		this.editor = editor;
