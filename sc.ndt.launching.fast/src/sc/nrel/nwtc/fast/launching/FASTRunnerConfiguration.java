 ...
 */
public class FASTRunnerConfiguration {
	 ...
	 */
	public FASTRunnerConfiguration(String classToLaunch, String[] classPath) {
	 ...
	 * @since 2.0
	 */
	public void setFASTSpecificAttributesMap(Map<String, Object> map) {
	 ...
	 */
	public void setFASTArguments(String[] args) {
		if (args == null) {
	 ...
	 * @since 2.0
	 */
	public Map<String, Object> getFASTSpecificAttributesMap() {
	 ...
	 * @see IFASTLaunchConfigurationConstants
	 */
