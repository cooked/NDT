 ...
 */
public interface IFASTLaunchConfigurationConstants {
	 ...
	 */
	public static final String ID_FAST_APPLICATION = LaunchingPlugin.getUniqueIdentifier() + ".localFASTApplication"; //$NON-NLS-1$
	 ...
	 * @since 3.2
	 */
	public static final String ATTR_JRE_CONTAINER_PATH = FASTRuntime.JRE_CONTAINER;
