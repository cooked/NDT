 ...
 * @see	IVMInstall
 */
public interface IFASTInstallType {
	/**
	 ...
	 */
	IFASTInstall createFASTInstall(String id);
	/**
	 ...
	 */
	IFASTInstall findFASTInstall(String id);
	/**
	 ...
	 * @since 2.0
	 */
	IFASTInstall findFASTInstallByName(String name);	
