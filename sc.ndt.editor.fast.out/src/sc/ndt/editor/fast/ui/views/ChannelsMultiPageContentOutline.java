...
public class ChannelsMultiPageContentOutline extends Page implements IContentOutlinePage, ISelectionProvider, ISelectionChangedListener {
	...
	private MultiPageFASTOutEditor editor;

	public ChannelsMultiPageContentOutline(MultiPageFASTOutEditor editor) {
		this.editor = editor;
