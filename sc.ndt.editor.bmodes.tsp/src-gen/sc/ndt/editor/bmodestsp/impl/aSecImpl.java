 ...
 * <ul>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getSec_loc <em>Sec loc</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getStr_tw <em>Str tw</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getTw_iner <em>Tw iner</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getMass_den <em>Mass den</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getFlp_iner <em>Flp iner</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getEdge_iner <em>Edge iner</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getFlp_stff <em>Flp stff</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getEdge_stff <em>Edge stff</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getTor_stff <em>Tor stff</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getAxial_stff <em>Axial stff</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getCg_offst <em>Cg offst</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getSc_offst <em>Sc offst</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodestsp.impl.aSecImpl#getTc_offst <em>Tc offst</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
