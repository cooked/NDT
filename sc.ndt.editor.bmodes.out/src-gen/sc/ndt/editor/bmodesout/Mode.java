 ...
 * <ul>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getIndex <em>Index</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getFreq <em>Freq</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getSpan_loc <em>Span loc</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getFlap_disp <em>Flap disp</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getFlap_slope <em>Flap slope</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getLag_disp <em>Lag disp</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getLag_slope <em>Lag slope</em>}</li>
 *   <li>{@link sc.ndt.editor.bmodesout.Mode#getTwist <em>Twist</em>}</li>
 * </ul>
 * </p>
 *
 * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode()
 * @model
 * @generated
 */
public interface Mode extends EObject
{
   ...
   * @see #setIndex(int)
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Index()
   * @model
   * @generated
   */
  int getIndex();
  ...
  /**
   * Sets the value of the '{@link sc.ndt.editor.bmodesout.Mode#getIndex <em>Index</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setFreq(float)
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Freq()
   * @model
   * @generated
   */
  float getFreq();
  ...
  /**
   * Sets the value of the '{@link sc.ndt.editor.bmodesout.Mode#getFreq <em>Freq</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Span_loc()
   * @model unique="false"
   * @generated
   */
   ...
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Flap_disp()
   * @model unique="false"
   * @generated
   */
   ...
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Flap_slope()
   * @model unique="false"
   * @generated
   */
   ...
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Lag_disp()
   * @model unique="false"
   * @generated
   */
   ...
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Lag_slope()
   * @model unique="false"
   * @generated
   */
   ...
   * @see sc.ndt.editor.bmodesout.BmodesoutPackage#getMode_Twist()
   * @model unique="false"
   * @generated
   */
