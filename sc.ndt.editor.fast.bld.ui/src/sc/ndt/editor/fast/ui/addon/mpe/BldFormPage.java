...
import sc.ndt.commons.model.BladeNodeStruct;
import sc.ndt.commons.model.BladeNodeStructList;
...
public class BldFormPage extends FormPage {
	...
	private BladeNodeStructList bs = new BladeNodeStructList();
	
	private ModelFastbld m;
	private Table table;
	 ...
	 * @param title
	 */
	public BldFormPage(String id, String title) {
		super(id, title);
	}
	 ...
	 */
	public BldFormPage(FormEditor editor, String id, String title) {
		super(editor, id, title);

		if(document==null && getEditor() instanceof IXtextFormEditor) {
			XtextEditor e = ((IXtextFormEditor)getEditor()).getXtextEditor("bld");
		...
		for(int i = 0; i < ast.getBldfrac().size(); i++) {
			bs.add(new BladeNodeStruct(
					ast.getBldfrac().get(i),
					ast.getAeroCent().get(i),
					ast.getStrcTwst().get(i),
					ast.getFlpStff().get(i),
					ast.getEdgStff().get(i),
					ast.getGJStff().get(i) ));
		}
		...
		sctnOutputList.setText("Blade");
				...
				tableViewerColumnID.setLabelProvider(new ColumnLabelProvider() {
					  ...
					  public String getText(Object element) {
					    return Integer.toString(bs.indexOf( (BladeNodeStruct) element));
					  }
					});
				...
				tableColumnAirfoil.setText("Section");
				tableViewerColumnAirfoil.setLabelProvider(new StructListLabelProvider()); 
							...
							public void afterEditorActivated(final ColumnViewerEditorActivationEvent event) {
								...
								document.modify(new IUnitOfWork.Void<XtextResource>() {
									...
									public void process(XtextResource resource) throws Exception {
										ModelFastbld m = (ModelFastbld) resource.getContents().get(0);
