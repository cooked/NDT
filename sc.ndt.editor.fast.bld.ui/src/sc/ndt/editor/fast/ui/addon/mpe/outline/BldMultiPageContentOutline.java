...
import sc.ndt.editor.fast.ui.addon.mpe.BldMultiPageEditor;

public class BldMultiPageContentOutline extends Page implements IContentOutlinePage, ISelectionProvider, ISelectionChangedListener {
	...
	private BldMultiPageEditor editor;

	public BldMultiPageContentOutline(BldMultiPageEditor editor) {
		this.editor = editor;
